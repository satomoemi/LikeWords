...
Route::group(['middleware' => 'auth:user'], function() {
    ...
    Route::get('/unsubsc', 'HomeController@UnsubscForm')->name('unsubsc');
    Route::post('/unsubsc','HomeController@delete');
    // Route::get('/user/edit/delete','Auth\UserEditController@WithdrawalForm')->name('user.edit.delete');
});
...
Route::group(['middleware' => ['auth']], function() {    
    ...
    Route::post('/user/edit/birthday','UserEditController@BirthdayUpdate')->name('edit.email');
    Route::post('/user/edit/email','UserEditController@EmailUpdate')->name('edit.email');
