...
Route::group(['middleware' => 'auth'], function() {
    //フォルダ系
    Route::get('/home/{id}', 'HomeController@folder')->name('home');
    ...
    Route::get('/home/folder/delete', 'HomeController@FolderDelete')->name('folder.delete');

    //ワード系
    Route::get('/home/createword/{id}', 'WordController@CreateWordForm')->name('create.word');
    Route::post('/home/createword/{id}', 'WordController@CreateWord');
});
