...
Route::group(['middleware' => 'auth'], function() {
    //フォルダ系
    Route::get('/home', 'HomeController@folder')->name('home');
    Route::get('/home/createfolder', 'HomeController@CreateFolderForm')->name('create.folder');
    Route::post('/home/createfolder', 'WordController@CreateFolder');

    //ワード系
    Route::get('/home/createword', 'HomeController@CreateWordForm')->name('create.word');
});
