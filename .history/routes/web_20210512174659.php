...
Route::group(['middleware' => 'auth:user'], function() {
    ...
    Route::get('/unsubsc', 'HomeController@unsubsc')->name('unsubsc');
    Route::get('/user/edit/delete','Auth\UserEditController@WithdrawalForm')->name('user.edit.delete');
    Route::post('/user/edit/Withdrawal','UserEditController@Withdrawal');
});

Route::group(['middleware' => ['auth']], function() {    
    
    Route::get('/user', 'Auth\UserEditController@UserEditForm')->name('user');
