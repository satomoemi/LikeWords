...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/home/createfolder', 'HomeController@ShowCreateFolder')->name('create.folder');
    Route::post('/home/createfolder', 'HomeController@CreateFolder')Route::get('/push', 'PushController@push')->name('push');
});
