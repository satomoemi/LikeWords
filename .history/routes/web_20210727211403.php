...
ute::group(['prefix' => 'admin'], function() {  
    Route::get('register', 'Admin\HomeController@showRegisterForm')->name('admin.register');
    Route::post('register', 'Admin\HomeController@register');
});
/*
|--------------------------------------------------------------------------
| 4) Admin ログイン後
