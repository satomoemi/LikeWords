                    ...
                    <div class="card-body">
                        ...
                        @csrf  
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input  id="gender" type="radio" name="gender" class="btn-check @error('gender') is-invalid @enderror"  value="{{ $auth["gender"] =='男'? "checked" : "" }}">男

                                    <input id="gender1" type="radio" name="gender" class="btn-check @error('gender') is-invalid @enderror" value="女" {{ $auth["gender"] =='女'? "checked" : "" }}" >

                                    <input id="gender2" type="radio" name="gender" class="btn-check @error('gender') is-invalid @enderror"  value="{{ $auth["gender"] == '答えたくない'? "checked" : "" }}">
                                    答えたくない
