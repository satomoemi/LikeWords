        ...
        <div class="mx-auto col-md-8">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('update.word',['folder_id' => $folder->id]) }}" >
              @csrf

                <div class="form-group row">
                  <label for="word">Word</label>
                  <input type="text" class="form-control @error('word') is-invalid @enderror" name="word" value="{{ old('word') }} {{ $word->word }}">{{ $word->word }}
