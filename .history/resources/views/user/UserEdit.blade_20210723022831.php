                    ...
                    <div class="card-body bg-dark">
                        ...
                        @csrf  
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input  id="gender" type="radio" name="gender" class="btn-check text-white @error('gender') is-invalid @enderror"  value="男" {{ $auth["gender"] =='男'? "checked" : "" }} > 男

                                    <input id="gender1" type="radio" name="gender" class="btn-check text-white @error('gender') is-invalid @enderror" value="女" {{ $auth["gender"] =='女'? "checked" : "" }} > 女

                                    <input id="gender2" type="radio" name="gender" class="btn-check text-white @error('gender') is-invalid @enderror"  value="答えたくない" {{ $auth["gender"] == '答えたくない'? "checked" : "" }}>
                                    答えたくない
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <input type="hidden" name="UserId" value={{$auth["id"]}}>
                                <button dusk="view-button" class="btn btn-outline-dark">更新</button>
