...
@section('content')
@if($push->doesntExist())
<h1>通知の登録をONにしてから通知時間を設定してください</h1>
@else
<div class="container">
        ...
        <div class="card-body">
          ...
          @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="time" name="push_time" value={{ $pushtime = NULL || $push->doesntExist() ? "" : $pushtime }}  class="form-control @error('push_time') is-invalid @enderror">
