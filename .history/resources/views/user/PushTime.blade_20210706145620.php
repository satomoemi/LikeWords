        ...
        <div class="card-body">
          ...
          @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="time" name="push_time" value=$pushtime["push_time"] {{$pushtime["push_time"] ！= NULL ? " " : $pushtime["push_time"] }} class="form-control @error('push_time') is-invalid @enderror">
