                    ...
                    <div class="card-body bg-dark">
                        ...
                        @csrf  
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input  id="gender" type="radio" name="gender" class="btn-check @error('gender') is-invalid @enderror"  value="男" {{ $auth["gender"] =='男'? "checked" : "" }} > <label class="text-white">男

                                    <input id="gender1" type="radio" name="gender" class="btn-check  @error('gender') is-invalid @enderror" value="女" {{ $auth["gender"] =='女'? "checked" : "" }} > <label class="text-white">女</label>
