    ...
    <div class="container">
        <div class="row col-md-12 justify-content-center">
            ...
            <div class="row col-md-12 py-5 justify-content-center">
                ...
                <label class="col-md-7 col-form-label text-md-right text-white"><h3>あなたのオリジナルのWord帳にするため<br>「新規会員登録」から登録します</h3></label>
            </div>

            <div class="row col-md-12 py-5 justify-content-center">
                <img src="/storage/<img src="/storage/登録のピクトアイコン2.jpeg" class="img-fluid" alt="">" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</div>
