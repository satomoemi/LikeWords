...
https://images.pexels.com/photos/167682/pexels-photo-167682.jpeg?cs=srgb&dl=pexels-lumn-167682.jpg&fm=jpg" class="img-fluid" alt="ログイン画面背景写真">
    <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-center">
        <h3 class="display-4" style="">好きなWordを！<br></h3>
            <p class="mb-4 lead">記録したい「単語」「定型文」「メモ」を登録でき、毎日ランダムに好きな時間に通知してくれる語学学習アプリです。<br>あなただけのWord帳になるようにご登録よろしくお願いします！<br></p>
                <h4 contenteditable="true">毎日の継続で語学力をアップを目指しましょう！</h4>
        </div>
        <div class="col-md-6">
            <div class="card">
