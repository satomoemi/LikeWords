                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="gender1" type="radio" class="btn-check @error('gender') is-invalid @enderror" name="gender" value="女"{{ (old('gender') =='男') ? "checked" : "" }}>
                                女

                                <input id="gender2" type="radio" class="btn-check @error('gender') is-invalid @enderror" name="gender" value="答えたくない">
                                答えたくない
