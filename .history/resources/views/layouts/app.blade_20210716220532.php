        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="nav navbar-nav ml-auto justify-content-e">
                        ...
                        @else
                                ...
                                <li class="nav-item">
                                    <a class="" href="{{ route('user') }}">ユーザー情報</a>
                                </li>
                                <li class="nav-item">
                                    <a class="" href="{{ route('push.time') }}">通知時間設定</a>
                                </li>
                                <li class="nav-item">
                                    <a class="" href="{{ route('unsubsc') }}">退会</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <!-- <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre> -->
                                    {{ Auth::user()->name }}さんようこそ！ <span class="caret"></span>
                                <!-- </a> -->
                            </li>
